package proto {
	...
	public dynamic final class PlayerInfo2 extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		 ...
		 *  @private
		 */
		public static const EQUIPS:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("proto.PlayerInfo.equips", "equips", (4 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return proto.Equip2; });
		...
		override public final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 3:
					...
					break;
				case 4:
					this.equips.push(com.netease.protobuf.ReadUtils.read$TYPE_MESSAGE(input, new proto.Equip2()));
					break;
				case 5:
					if (exp$count != 0) {
