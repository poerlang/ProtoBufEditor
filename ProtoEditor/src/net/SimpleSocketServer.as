package net
{
	 ...
	 * 
	 * 		s.addEventListener(SimpleSocketServer.SOCKET_SERVER_ALERT,function(e:DataEvent):void			<br>
	 *		{																								<br>
	 *			trace(e.data);																				<br>
	 *		});																								<br>
	 */
	public class SimpleSocketServer extends EventDispatcher
	{
		...
		public static var SOCKET_SERVER_ALERT:String = "SOCKET_SERVER_ALERT";
		private function alert(str:String):void
		{
			dispatchEvent(new DataEvent(SOCKET_SERVER_ALERT,false,false,str));
		}
